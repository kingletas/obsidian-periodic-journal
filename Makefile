# Periodic Journal — an Obsidian plugin
#
# Run `make` with no arguments for the list.
#
# Obsidian loads a plugin out of <vault>/.obsidian/plugins/periodic-journal/, so the built
...
help: ## Show this help
	@echo
	@echo "  Periodic Journal — an Obsidian plugin"
	@echo
